...
const stories = storiesOf('scrollbar', module).addDecorator(centered);

stories.add('default', () => {
  return (
    <Scrollbar style={{ width: '200px', height: '200px' }}>
      <div style={{ width: '200px', height: '200px' }}>
        ...
        <p>
          asdasssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssddsssssssssssssssssssssssssssssss
        </p>
      </div>
    </Scrollbar>
  );
